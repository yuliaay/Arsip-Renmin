        ...
        <?php require_once 'footer.php'; ?>
      	...
      	<div id="content">
            <nav id="navbar-example2" class="navbar navbar-light bg-light">
              <header>
               <a href="cetakTerusanDisposisi.php"> <button type="submit" class="btn btn-success pull-right"  name="submit" value="Cetak Data" id="btncetak"> <span class="glyphicon glyphicon-download-alt"></span> Cetak  </button> </a>
                <p class="page_title"> Data Terusan Disposisi </p>  
              </header>
              <?php 
