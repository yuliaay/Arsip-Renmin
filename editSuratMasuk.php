...
if(isset($_GET['id'])){
  $surat = tampilkan_perid_suratmasuk($id);
  while ($row = mysqli_fetch_assoc($surat)){
    ...
    $disposisi_awal = $row ['disposisi'];
    $tgl_ekspedisi_awal = $row ['tgl_ekspedisi'];
    $id_awal = $row ['id'];
  }
}
...
if(isset($_POST['submit'])){
  ...
  if(!empty(trim($no_surat)) && !empty(trim($isi_surat))){
    if(edit_surat_masuk($no_surat, $tgl_surat, $asal_surat, $tgl_terima, $isi_surat, $jenis_surat, $no_agenda, $disposisi, $tgl_ekspedisi, $id )){
    echo "
      <script>
    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div id="content">
          ...
          <header>
            <p class="page_title"> Edit Surat Masuk </p>  
          </header>

      
         <form class= "formSM" method="post" action="editSuratMasuk.php">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="asal_surat" placeholder="Asal Surat" value="<?=@$asal_surat_awal; ?>" required>
            </div>
          </div>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control" name="tgl_terima" placeholder="Tanggal Terima" value="<?=@$tgl_terima_awal; ?>" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="no_agenda" placeholder="Nomor Agenda" value="<?=@$no_agenda_awal; ?>" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="disposisi" placeholder="Disposisi" value="<?=@$disposisi_awal; ?>" required>
            </div>
          </div>

           <div class="form-group row">
            <label for="tgl_ekspedisi" class="col-sm-2 col-form-label">Tanggal Ekspodisi</label>
            <div class="col-sm-10">
              <input type="date" class="form-control" name="tgl_ekspedisi" placeholder="Tanggal Ekspedisi" value="<?=@$tgl_ekspedisi_awal; ?>">
            </div>
          </div>
