...
if(isset($_POST['submit'])){
  ...
  $tgl_ekspedisi = $_POST['tgl_ekspedisi'];

if(!empty(trim($no_surat)) && !empty(trim($isi_surat))){
 
  if(tambah_surat_masuk($no_surat, $tgl_surat, $asal_surat, $tgl_terima, $isi_surat, $jenis_surat, $no_agenda, $disposisi, $tgl_ekspedisi)){ 
    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div id="content">
         ...
         <form class= "formSM" method="post" action="inputSuratMasuk.php">
